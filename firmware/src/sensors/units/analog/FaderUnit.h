...
class FaderUnit : public Unit {
 public:
  /**
   * @brief Construct a FaderUnit bound to a PortC GPIO resource.
   *
   ...
   */
  FaderUnit(PortC& port, UnitModel _model);
